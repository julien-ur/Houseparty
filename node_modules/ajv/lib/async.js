 ...
 * `loadSchema` option should be a function that accepts schema uri and node-styles callback.
 * @this  Ajv
 * @param {Object}   schema schema object
 * @param {Function} callback node-styles callback, it is always called with 2 parameters: error (or null) and validating function.
 */
